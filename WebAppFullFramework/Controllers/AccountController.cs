...
namespace WebAppFullFramework.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var dataProtectionProvider = new DpapiDataProtectionProvider("ASP.NET Identity");
            ...
            UserManager.SendEmail(user.Id, "Recuperação de Senha", $"<div>Para recuperar a senha <a target=\"_blank\" href=\"{ Url.Action("ResetPassword", "Account", new { code = token }, protocol: Request.Url.Scheme)}\">clique no link</div>");
            ViewBag.Result = "E-mail enviado...";
            return View();
        }
